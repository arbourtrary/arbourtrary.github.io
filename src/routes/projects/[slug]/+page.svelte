...
<div class="more">
    {#if data.project.prev}
        <a href={base + `/projects/${data.project.prev.slug}`} style="margin-right: 15px; margin-left: 0px;">
    ...
    {#if data.project.next}
        <a href={base + `/projects/${data.project.next.slug}`} style="margin-left: 15px; margin-right: 0px;">
