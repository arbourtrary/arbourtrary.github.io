...
<div class="header">
    <!-- <a href={base + "/"} aria-label="Homepage link">
        <div class="home">
...
<div class="more">
    {#if data.writing.prev}
        <a href={base + `/writings/${data.writing.prev.slug}`} style="margin-right: 15px;">
    ...
    {#if data.writing.next}
        <a href={base + `/writings/${data.writing.next.slug}`} style="margin-left: 15px;">
